...
(R --vanilla --args $1 $2.$user.$curdate topmedid $2.$user.$curdate.no.duplicates.csv $3 clusters.list.sqrt_v4.RData < Freeze5b.T2D.PostProcessing.GitHub.R >> $1/$2.$user.$curdate.harm.stdout.txt 2>&1) &
